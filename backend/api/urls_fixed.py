...
urlpatterns = [
    ...
    path('failures/<uuid:pk>/resolve/', resolve_failure, name='resolve_failure'),
    ...
    path('k8s/pods/<uuid:pod_id>/logs/', get_k8s_pod_logs, name='get_k8s_pod_logs'),
    ...
    path('k8s/workloads/<uuid:workload_id>/delete/', delete_k8s_workload, name='delete_k8s_workload'),
    ...
    path('cost/recommendations/<uuid:pk>/apply/', apply_cost_recommendation, name='apply_cost_rec'),
    path('terraform/scale/', scale_terraform, name='scale_terraform'),
    path('terraform/destroy/', destroy_terraform, name='destroy_terraform'),
    path('failures/<uuid:pk>/ai-patch/', get_ai_patch, name='get_ai_patch'),
