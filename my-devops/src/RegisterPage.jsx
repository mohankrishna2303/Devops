...
const RegisterPage = () => {
    ...
    return (
        <div>
            ...
            {error && (
                <div style={{ background: 'rgba(255, 61, 0, 0.1)', border: '1px solid var(--primary)', padding: '12px', borderRadius: '8px', color: 'var(--primary)', marginBottom: '20px', fontSize: '14px', textAlign: 'center' }}>
                    {error}
                </div>
            )}
