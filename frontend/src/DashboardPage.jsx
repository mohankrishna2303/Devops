...
const DashboardPage = () => {
    ...
    const [selectedProjectId, setSelectedProjectId] = useState(location.state?.projectId || null);
    const [selectedPipelineId, setSelectedPipelineId] = useState(location.state?.pipelineId || null);
    ...
    useEffect(() => {
        ...
        if (location.state?.pipelineId) {
            setSelectedPipelineId(location.state.pipelineId);
        }
    }, [location]);
