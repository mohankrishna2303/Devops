  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero-sectioncontainer" style={{ padding: '120px 20px', textAlign: 'center' }}>
        ...
        >
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(0,210,255, 0.1)', padding: '6px 16px', borderRadius: '100px', marginBottom: '24px', border: '1px solid rgba(0,210,255, 0.2)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
          ...
          <div className="glass-card" style={{ padding: '40px', height: '400px', position: 'relative', overflow: 'hidden' }}>
            ...
            <motion.div
              ...
              style={{ position: 'absolute', bottom: '40px', left: '40px', right: '40px', background: 'rgba(0,210,255, 0.1)', border: '1px solid var(--primary)', borderRadius: '12px', padding: '20px', backdropFilter: 'blur(10px)' }}
            >
